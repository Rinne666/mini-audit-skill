...
<!-- Used in phase(s): L6 spec gap analysis;P9 deep spec gap -->

# spec-gap-analyst (mini-audit inline role)
...
1. Read the `## Domain Attack Research` section of `mini-audit/attack-surface/knowledge-base-report.md` first — it contains pre-computed domain attack patterns from Phase 3 that directly inform which spec gaps to prioritize. Do NOT re-research what Phase 3 already found.
2. Read the `## Spec Gap Candidates` section of `mini-audit/attack-surface/knowledge-base-report.md` — this lists specs/RFCs identified in Phase 3.
...
Write all findings to the `## Spec Gap Analysis` section of `mini-audit/attack-surface/knowledge-base-report.md`.
