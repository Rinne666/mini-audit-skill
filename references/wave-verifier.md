...
<!-- Used in phase(s): I2 cross-agent reinvest wave verification -->

# wave-verifier (mini-audit inline role)
...
Write your full review to `mini-audit/findings/<ID>-<slug>/wave-<N>-verdict.md` with this shape:
