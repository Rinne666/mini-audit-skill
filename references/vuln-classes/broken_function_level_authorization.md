<!-- mini-audit: vulnerability class reference (strix skills) -->
<!-- Source: strix/strix/skills/vulnerabilities/broken_function_level_authorization.md -->
<!-- Loaded by: code-tracer / devils-advocate when verifying hypotheses of class "broken_function_level_authorization" -->
